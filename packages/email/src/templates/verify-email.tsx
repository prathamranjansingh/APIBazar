const APIBAZAR_LOGO = "https://assets.dub.co/wordmark.png";
...
export function VerifyEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your ApiBazar Verification Code</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[600px] rounded border border-solid border-neutral-200 px-10 py-5">
            <Section className="mt-8">
              <Img src={APIBAZAR_LOGO} height="32" alt="Apibazar" />
            </Section>
            <Heading className="mx-0 my-7 p-0 text-xl font-medium text-black">
              Please confirm your email address
            </Heading>
            <Text className="mx-auto text-sm leading-6">
              Enter this code on the ApiBazar verify page to complete your sign
              up:
            </Text>
